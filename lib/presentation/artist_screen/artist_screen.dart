...
class ArtistScreen extends StatelessWidget {
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(children: [
                  _buildRenaissance(context),
                  SizedBox(height: 43.v),
                  _buildRenaissance1(context)
                ]))));
  }
  ...
  /// Section Widget
  Widget _buildRenaissance(BuildContext context) {
  ...
  /// Section Widget
  Widget _buildRenaissance1(BuildContext context) {
    return SizedBox(
        height: 230.v,
        child: BlocSelector<ArtistBloc, ArtistState, ArtistModel?>(
            ...
            builder: (context, artistModelObj) {
              return ListView.separated(
                  ...
                  itemCount: artistModelObj?.renaissanceItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    RenaissanceItemModel model =
                        artistModelObj?.renaissanceItemList[index] ??
